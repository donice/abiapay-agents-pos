...
var SignageRoadComponent = function (_a) {
    var _b = useState({
        vehicle_make: "",
        vehicle_model: "",
        vehicle_color: "",
    ...
    return (<div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="absaa-form">
        ...
        <SelectInput label="Road Category" name="road_name" id="road_name" options={[
            {
        ...
        <FormTextInput label="Road Name" name="amount" placeholder="Enter Road Name" register={register} validation={{
            required: true,
        }} error={errors.amount}/>
         <SelectInput label="Status" name="status" id="status" options={[
            {
                label: "Select Status",
                value: "",
            },
        ...
        ]} placeholder="Select Status" register={register} validation={{ required: true }}/>

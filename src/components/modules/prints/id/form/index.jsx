...
var BulkPrintForm = function (_a) {
    var setBulkData = _a.setBulkData, setViewData = _a.setViewData;
    var _b = useState("bulk"), selectedTab = _b[0], setSelectedTab = _b[1];
    ...
    var _h = useMutation({
        ...
        onSuccess: function (data) {
            if ((data === null || data === void 0 ? void 0 : data.response_code) === "00") {
                ...
                toast.error((data === null || data === void 0 ? void 0 : data.response_message) || "Search failed");
            }
        },
    ...
    return (<div className="bulk_print_page">
      ...
      <div className="tab_selector">
        <button className={selectedTab === "bulk" ? "active" : ""} onClick={function () { return setSelectedTab("bulk"); }}>
          Bulk Print
        </button>
        <button className={selectedTab === "search" ? "active" : ""} onClick={function () { return setSelectedTab("search"); }}>
          Search
        </button>
        <button className={selectedTab === "multi" ? "active" : ""} onClick={function () { return setSelectedTab("multi"); }}>
          Multi Search
        </button>
      </div>

      {/* ---- Single Search ---- */}
      {selectedTab === "search" && (<div className="search_wrapper">
      ...
      {/* ---- Multi Search ---- */}
      {selectedTab === "multi" && (<div className="multi_search_wrapper">
      ...
      {/* ---- Bulk Print ---- */}
      {selectedTab === "bulk" && (<form onSubmit={handleSubmit(onSubmit)} className="emblem_form">

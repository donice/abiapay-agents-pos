...
var UserSettingsComponent = function () {
    ...
    return (<div className="settings">
      ...
      <div className="settings_items">
        {walletItems.map(function (item) { return (<Link href={"".concat(item.cat === "coming soon" ? "/user/settings" : item.href)} key={item.href}>
      ...
      <div className="settings_items_service">
        {dailyServices.map(function (item) { return (<Link href={"".concat(item.cat === "coming soon" ? "/user/settings" : item.href)} key={item.href}>
            <a className={"settings_item"}>
      ...
      <div className="settings_items_service">
        {otherServices.map(function (item) { return (<Link href={"".concat(item.href)} key={item.href}>
            <a className={"settings_item"}>
              <div>
                {" "}

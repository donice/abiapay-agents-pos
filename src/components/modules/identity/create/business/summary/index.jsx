...
import { createBusinessAbssin, } from "@/src/services/identityService";
...
var Summary = function (_a) {
    ...
    var mutation = useMutation({
        mutationFn: function (data) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, createBusinessAbssin(data)];
        }); }); },
    ...
    var handleSubmit = useForm({}).handleSubmit;
    return (<div>
      <form onSubmit={handleSubmit(onSubmit)} className="button-container">
        <button className="button secondary" onClick={function () { return setStage(2); }}>
          Go Back
        </button>
        <Button text={"Proceed"}/>
      </form>

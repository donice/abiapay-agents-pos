...
var DashboardBanner = function () {
    return (<div className="dashboard-banner">
      <div className="dashboard-banner_content">
        <div>
          ...
          <h1>
            Abiapay is better on <span> the mobile app</span>
          </h1>
          <p>Download Now</p>
        </div>
        <a href="https://play.google.com/store/search?q=abiapay&c=apps&hl=en" target="_blank" rel="noopener noreferrer" className="dashboard-banner_content_download">

      ...
      <section>
        ...
        <div className="find-comp-form ">
          <form
            ...
            className="verify-tickets-form mb-4"
          >
            <FormTextInput
              label="ABSSIN"
              type="text"
            ...
            <div className="mt-4">
              <Button
                text={loading ? "Verifying..." : "Verify ABSSIN"}
                loading={loading}
              />
            </div>
          </form>
          ...
          <div className="main-table">
            {displayDetails && displayDetails.length ? (
              <div className="">
                ...
                <div
                  className="generate-notice-button"
                  style={{ marginTop: "1rem" }}
                >
                  {displayDetails[0].cdn_category_id !== null &&
                  displayDetails[0].cdn_category_id !== 0 ? (
                    <Button
                      text="Generate Demand Notice"
                      onClick={handleGenerateDemandNotice}
                    />
                  ) : (
                    <div className="text-yellow-700 text-xs bg-yellow-50 p-2 rounded border border-yellow-300">
                      Oops! We could not create Demand Notice for this Business.
                      Kindly modify the Business ABSSIN and update the CDN
                      Category{" "}
                    </div>
                  )}
                </div>

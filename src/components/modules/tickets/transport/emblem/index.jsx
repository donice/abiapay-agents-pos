...
var TransportEmblemComponent = function () {
    ...
    return (<div>
      ...
      {show.mode && (<EmblemModal maintext={show.message} exp_date={show.expiry_date} payment_ref={show.payment_ref} button_text="View Receipt" onClick={function () {
                router.push("/tickets/transport/emblem/summary?payment_ref=".concat(show.payment_ref));
            }}/>)}
    </div>);
};

...
// import "../../transportTable/style.scss" // Moved to _app;
    ...
    return (<section className="main-table">
      {isLoading ? (<div className={"loading"}>
          ...
          <div className="filter-input">
            ...
            <input type="text" placeholder="Search by Vehicle Plate Number" value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="search input"/>
          </div>
          {filteredTransactions.length > 0 ? (<div className="main-table_form_tickets_container">
              <div className="tickets">
                {filteredTransactions.map(function (transaction) { return (<div key={transaction.payment_ref} className="ticket" onClick={function () {
                        return router.push("/tickets/transport/emblem/summary?payment_ref=".concat(transaction.payment_ref));
                    }}>
                    <div>
            ...
            </div>) : (<Empty text="No emblems found"/>)}
        </>)}
    </section>);
};

import { FcShipped, FcInTransit, FcAcceptDatabase, FcAutomatic, FcFactory, FcCloseUpMode, FcElectronics, FcFinePrint, FcGlobe, FcLandscape, FcShop, FcEngineering, } from "react-icons/fc";
export var haulages = [
    {

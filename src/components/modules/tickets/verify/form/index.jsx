...
var VerifyTicketsFrom = function (_a) {
    ...
    var mutation = useMutation({
        ...
        onSuccess: function (data) {
            var _a, _b;
            var res = (_a = data === null || data === void 0 ? void 0 : data.data) === null || _a === void 0 ? void 0 : _a.data;
            ...
            if ((data === null || data === void 0 ? void 0 : data.status) == 200) {
                if ((res === null || res === void 0 ? void 0 : res.response_code) == "00") {
                    ...
                    res.response_code == "97" &&
                        setDetails(res) &&
                        toast.error((_b = res.response_message) !== null && _b !== void 0 ? _b : "No ticket for today");
                }
            }
            else {
                return;
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="verify-tickets-form">
      <SelectInput label="Reference Type" name="verifyType" id="verifyType" register={register} options={[
            { label: "Plate Number", value: "plate_number" },
            { label: "Payment Reference", value: "payment_ref" },
            { label: "Emblem", value: "emblem" },
        ]} placeholder="Select Reference Type"/>
      <FormTextInput label="Reference Number" type="text" name="referenceID" placeholder="Enter Reference Number" register={register} validation={{
            required: true,
            minLength: {
                value: 7,

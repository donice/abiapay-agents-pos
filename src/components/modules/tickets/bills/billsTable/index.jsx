    ...
    return (<section className="main-table">
      {fetched_data.length > 0 ? (<div className="main-table_form_tickets_container">
          <div className="tickets">
            {fetched_data.map(function (transaction, index) { return (<div key={index} className="ticket" onClick={function () {
                    return router.push("/bills/".concat(transaction.transref));
                }}>
                <div>

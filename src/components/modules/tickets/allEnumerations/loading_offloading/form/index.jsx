...
import { createLoadingOffLoading, fetchLoadingOffloadingVehicleType, } from "@/src/services/loadingOffloadingService";
import { getCurrentYear } from "@/src/utils/getCurrentYear";
var LoadingOffLoadingForm = function (_a) {
    var setShow = _a.setShow;
    ...
    var getEmblemProductCode = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetchLoadingOffloadingVehicleType()];
                case 1:
                    data = _a.sent();
    ...
    var _d = useMutation({
        ...
        onSuccess: function (data) {
            ...
            if (data === null || data === void 0 ? void 0 : data.data.response_code) {
                ((_a = data === null || data === void 0 ? void 0 : data.data) === null || _a === void 0 ? void 0 : _a.response_code) == "00"
                    ? toast.success((_b = data === null || data === void 0 ? void 0 : data.data) === null || _b === void 0 ? void 0 : _b.response_message) &&
                        setShow({
                            mode: true,
                            message: data === null || data === void 0 ? void 0 : data.message,
                            expiry_date: "",
                            payment_ref: (_c = data === null || data === void 0 ? void 0 : data.data) === null || _c === void 0 ? void 0 : _c.payment_ref,
                        })
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="loading_form">
      ...
      <SelectInput label="Ticket Category" name="category" id="category" register={register} error={!!errors.category} validation={{ required: true }} options={[
            {
                label: "Loading",
                value: "loading",
            },
      ...
      <FormTextInput label={"Plate Number"} name={"plate_number"} placeholder="Enter Vehicle Plate Number" register={register} validation={{ required: true }} error={errors.plate_number}/>
      <FormTextInput label={"Taxpayer Phone Number"} name={"tax_payer_phone"} placeholder="Enter Taxpayer Phone Number" register={register} validation={{ required: true }} error={errors.tax_payer_phone}/>
      <FormTextInput label={"Taxpayer Name"} name={"tax_payer_name"} placeholder="Enter Taxpayer Name" register={register} validation={{ required: true }} error={errors.tax_payer_name}/>

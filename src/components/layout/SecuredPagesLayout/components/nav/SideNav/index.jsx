...
var SideNav = function ({ isCollapsed }) {
    ...
    return (<div className={"side-nav ".concat(isCollapsed ? "collapsed" : "")}>
        <div className="side-nav_items_container">
            <div className="side-nav_items">
                {nav_items
                    ...
                    .map(function (item) {
                        return (<Link href={"/".concat(item.name)} key={item.name}>
                            <a className={"side-nav_item ".concat(item.name === route ? "active" : "inactive")} title={isCollapsed ? item.title : ""}>
                                <span>{item.icon}</span>
                ...
                <Link href={"/signin"} key={"logout"}>
                    <a className="side-nav_item logout" title={isCollapsed ? "Sign Out" : ""}>
                        <span>

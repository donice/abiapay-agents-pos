...
export var createMarketEnumeration = function (requestBody) { return __awaiter(void 0, void 0, void 0, function () {
    var data, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance.post("".concat(url, "/market/market-enumeration"), requestBody)];
            case 1:
                data = (_a.sent()).data;
                return [2 /*return*/, data];
            case 2:

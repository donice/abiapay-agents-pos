...
var isToken = isBrowser && window.sessionStorage.getItem("TOKEN")
    ...
    : null;
setToken(isToken);
export var fetchAccountStatement = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance.post("".concat(url, "/wallet/my-statement"))];
            case 1:
                data = (_a.sent()).data;

...
export function https(url, options, params) {
    if (url === void 0) { url = base_url; }
    return __awaiter(this, void 0, void 0, function () {
        var urlParams, res, error, _a, data, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    error = new Error("HTTP error! status: ".concat(res.status));
                    _a = error;

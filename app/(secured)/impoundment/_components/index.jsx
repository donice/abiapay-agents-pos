...
var VehicleImpoundmentComponent = function () {
    var router = useRouter();
    return (<div className="impoundment">
      <header className="impoundment_header">
        <CustomHeader title="Vehicle Impoundment" desc="Manage/Create Vehicle Impoundment Ticket"/>

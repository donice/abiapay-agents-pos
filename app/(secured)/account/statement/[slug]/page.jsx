...
import { AccessTransferFunds, AccessWalletToWallet, fetchWalletInfo, FidelityTransferFunds, FidelityWalletToWallet, } from "@/src/services/walletService";
...
var StatementPage = function (_a) {
    ...
    }), watch = _e.watch, setValue = _e.setValue, registerTransferToBank = _e.register, errorsTransferToBank = _e.formState.errors, handleSubmitTransferToBank = _e.handleSubmit;
    var _f = useForm({
        defaultValues: {
            cashout_type: "",
            merchant_key: process.env.NEXT_PUBLIC_MERCHANT_KEY || "",
    ...
    var cashoutType = watch("cashout_type");
    ...
    return (<section className="other-wallet">
      ...
      <SelectInput label={"Cashout Type"} name={"cashout_type"} id={"cashout_type"} placeholder="Select Cashout Type" register={registerTransferToBank} options={[
            {
                value: "wallet",
      ...
      {cashoutType == "bank" && (<form onSubmit={handleSubmitTransferToBank(onSubmit)} className="other-wallet_form">
          {" "}

          <SelectInput label={"Bank Name"} name={"bank_code"} id={"bank_code"} register={registerTransferToBank} options={banks}/>
          <FormTextInput type="number" label={"Account Number"} name="bank_account" placeholder={"Enter Account Number"} register={registerTransferToBank} validation={{ required: true }} error={errorsTransferToBank.bank_account}/>
          ...
          <FormTextInput type="number" label={"Amount"} name={"amount"} placeholder="Enter Amount" register={registerTransferToBank} onChange={onChange} validation={{
          ...
          <FormTextInput label={"Description"} name={"desc"} placeholder="Enter Description" register={registerTransferToBank} validation={{ required: true }} error={errorsTransferToBank.desc}/>
      ...
      {showSuccessModal.show == true && showSuccessModal.mode == "success" && (<InformationModal mode="success" icon={<TbSend className="success_icon"/>} maintext={"Money sent successfully"} subtext="Your transaction has been completed successfully. You can check your transaction history in your account." link={"/account/statement"}/>)}

      {showSuccessModal.show == true && showSuccessModal.mode == "warning" && (<InformationModal mode="warning" 
        // icon={<TbSend className="warning_icon" />}
        maintext={"Insufficient funds"} subtext="Insufficient funds in your wallet. Please fund your wallet and try again." link={"/account/statement"}/>)}
    </section>);
};

...
import { AccessTransferFunds, fetchWalletInfo, FidelityTransferFunds, } from "@/src/services/walletService";
...
var StatementPage = function (_a) {
    ...
    return (<section className="bank">
      ...
      {cashoutType == "bank" && (<form onSubmit={handleSubmitTransferToBank(onSubmit)} className="bank_form">
          {" "}
          ...
          {isPending && (<p className="bank_form_beneficiary">
              <SmallLoader />{" "}
            </p>)}
          {beneficiary !== "" && !isPending && (<div className="bank_form_beneficiary">
              <p>{beneficiary}</p>
            </div>)}
      ...
      {showSuccessModal.show == true && showSuccessModal.mode == "success" && (<InformationModal mode="success" icon={<TbSend className="success_icon"/>} maintext={"Money sent successfully"} subtext="Your transaction has been completed successfully. You can check your transaction history in your account." link={"/account/bank"}/>)}

      {showSuccessModal.show == true && showSuccessModal.mode == "warning" && (<InformationModal mode="warning" 
        // icon={<TbSend className="warning_icon" />}
        maintext={"Insufficient funds"} subtext="Insufficient funds in your wallet. Please fund your wallet and try again." link={"/account/bank"}/>)}
    </section>);
};

...
var Dynamic = function () {
    ...
    return (<>
      {" "}
      <CustomHeader title={"Transfer to other banks"} desc={"Select your preferred bank"}/>
        ...
        <div className="bank">
          ...
          <p>
            ...
            <Button text={"Fidelity Bank Transfer"} onClick={function () {
            router.push("/wallet/transfer/bank/fidelity");
        }}/>
            <Button text={"Access Bank Transfer"} onClick={function () {

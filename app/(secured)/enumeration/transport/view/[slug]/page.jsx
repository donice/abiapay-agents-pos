...
import "./style.scss";
var ViewEnumeration = function (_a) {
    var params = _a.params;
    var _b = useState(null), enumData = _b[0], setEnumData = _b[1];
    var _c = useQuery({
    ...
    useEffect(function () {
        ...
        if (data) {
            ...
            var filteredData = (_a = data === null || data === void 0 ? void 0 : data.data) === null || _a === void 0 ? void 0 : _a.find(function (item) { return (item === null || item === void 0 ? void 0 : item.EnumerationID) === (params === null || params === void 0 ? void 0 : params.slug); });
        ...
        <div className="modalContentEnumContent">
          ...
          <div className="custom_vehicle_details">
            ...
            <div className="qr_container">
              <QRCode size={256} style={{ height: "auto", maxWidth: "100%", width: "100%" }} value={enumData.QrLink || "No QR data available"} viewBox={"0 0 256 256"}/>
            </div>
